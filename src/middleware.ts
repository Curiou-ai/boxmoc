...
// Improved validation: ensure keys are present and not placeholders
...
export async function middleware(request: NextRequest) {
  ...
  if (redis) {
    try {
      ...
      // Fail-open: If Upstash is unreachable or keys are invalid, allow the request
      console.warn('Rate limiter fetch failed (check your UPSTASH keys):', e);
    }
  }
