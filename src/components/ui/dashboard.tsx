...
const BOX_TYPES = [
  { 
    ...
    fontSize: 'text-xl xs:text-2xl sm:text-5xl', 
    // tagline: 'Cardboard • Tier 1',
    // dimensions: { w: 240, h: 140, d: 200 }
    dimensions: { w: 240, h: 230, d: 200 }
  },
  { 
    id: 'care', 
    label: 'Supplier Box', 
  ...
  { 
    ...
    fontSize: 'text-lg xs:text-xl sm:text-2xl',
    // tagline: '3D Printed • Tier 3',
    dimensions: { w: 150, h: 100, d: 150 }
  },
];
              ...
              <div className="box-3d" style={{ width: w, height: h }}>
                ...
                >
                  <span className={cn("font-sans font-extrabold text-xl xs:text-2xl sm:text-5xl", activeBox.textColor)}>
                    {activeBox.id === 'shipper' 
                      ? (
                        <span className={`${activeBox.fontSize}`}>
                          moura.
                        </span>
                      ) 
                      : activeBox.id === 'care' ? (<span className={`${activeBox.fontSize}`}>CARE</span>) 
                      : (<span className={`${activeBox.fontSize}`}>BESPOKE</span>)
                    }
                  </span>
                </div>
                {/* Bottom */}
